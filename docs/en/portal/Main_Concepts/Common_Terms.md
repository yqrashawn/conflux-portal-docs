...
## Words are Hard
<p id="agoctitecs_p">
  This is a list of terms you might encounter when using the Conflux Portal interface.
</p>
...
<ul>
  ...
  <li id="wallet_l2">Example: Conflux Portal, your Ledger Hardware Wallet, a Multisig Wallet Contract.</li>
</ul>
...
<ul>
  ...
  <li id="mphrase_l3">
    Used by Ledger, TREZOR, Conflux Portal, Jaxx, and others.
  </li>
  <li id="mphrase_l4">
